...
- {SourceProcessorClass<object, NodeSyntaxParser, CssProcessOptions>}
...
* `input` {string}
* `options` {CssProcessOptions|object|object}
* Returns: {object}
...
* Returns: {SourceProcessorClass<object, NodeSyntaxParser, CssProcessOptions, object>}
